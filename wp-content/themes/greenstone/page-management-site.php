<?php /* Template Name: Management-Site */ get_header('management'); ?>
			...
			<div class="content">
				...
				<div class="button">
					<div class="button-guts">
						<a href="<?php the_field('tenant_login_url'); ?>" target="_blank">
				...
				<div class="flex-between">
					<div class="width66">
						...
						<div class="facts-tile">
							...
							<h3 class="factsTrigger"></h3>
						</div>
						<!-- <div class="button management-button">
							<div class="button-guts">
								<a href="http://gs-management.com" target="_blank">
